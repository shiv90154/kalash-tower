    ...
    <html lang="en" className={`${playfair.variable} ${inter.variable}`} data-scroll-behavior="smooth">
      ...
      <body className="font-body antialiased flex flex-col min-h-screen">
        ...
        <a
          ...
          className="fixed bottom-20 md:bottom-8 right-8 z-50 flex items-center gap-2 bg-green-600 text-white px-5 py-3 rounded-full shadow-lg hover:bg-green-700 transition-all duration-300 hover:scale-105 group"
        ...
        >
          ...
          <span className="hidden group-hover:inline-block text-sm font-medium">Chat with us</span>
        </a>
      </body>
    </html>
  );
