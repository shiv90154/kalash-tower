...
>
  ...
  <span className="absolute bg-green-600 right-full mr-3 hidden group-hover:inline-block text-sm font-medium text-white px-3 py-1 rounded-lg whitespace-nowrap">
    Chat with us
    <span className="absolute top-1/2 -translate-y-1/2 right-0 translate-x-full border-4 border-transparent border-l-green-800"></span>
  </span>
</a>
  );
}