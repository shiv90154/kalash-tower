        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-1 mb-6 group">
              <span className="text-2xl font-classic font-bold text-white group-hover:text-classic-gold transition-colors">
                Natraj
              </span>
              <span className="text-xl font-light text-gray-400">Properties</span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed mb-6 max-w-md">
              Distinguished office spaces, flats, kothi & land in Mohali &
              Chandigarh. Over 15 years of trust.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-classic font-semibold text-white mb-6 border-b border-classic-gold/50 pb-2">
              Quick Links
            </h4>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-gray-400 hover:text-classic-gold"
                >
                  +91 98765 43210
                </a>
              </li>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          ...
          <div className="flex gap-6">
            ...
            <button
              ...
              className="hover:text-classic-gold"
            >
              Back to top ↑
            </button>
          </div>
