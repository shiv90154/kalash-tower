...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-classic-bg text-classic-text overflow-hidden font-bold">
      {/* Subtle background pattern (classic primary dots) */}
      ...
      {/* Reduced vertical padding, and reduced horizontal padding */}
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-classic-text-light leading-relaxed mb-6 max-w-md">
              Discover distinguished office spaces, premium flats, luxurious kothis, and valuable land opportunities across Mohali & Chandigarh. Backed by over 15 years of trusted expertise, we deliver reliable guidance, transparent deals, and a seamless property experience tailored to your needs.
            </p>
          </div>
          ...
          {/* Contact – social icons removed from here */}
          <div>
            <h4 className="font-classic font-semibold text-lg text-classic-primary mb-4 relative inline-block">
            ...
            <ul className="space-y-3 text-sm mb-6">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919876543210" className="text-classic-text-light hover:text-classic-primary transition-colors">
                  +91 98765 43210
                </a>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-classic-gold text-lg">✉️</span>
                <a href="mailto:info@natrajproperties.com" className="text-classic-text-light hover:text-classic-primary transition-colors">
      ...
      <div className="border-t border-classic-gold/20">
        <div className="mx-auto max-w-7xl px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-classic-text-light">
          ...
          <div className="flex gap-4 cursor-pointer">
            {[
              ...
              <a
                key={idx}
                href={social.href}
                className="w-10 h-10 flex items-center justify-center rounded-full border border-classic-gold/30 text-classic-text-light hover:bg-classic-gold hover:text-white hover:border-classic-gold transition-all duration-300 hover:shadow-lg hover:shadow-classic-gold/20 hover:scale-110"
                target="_blank"
          ...
          <div className="flex gap-6">
            <Link href="/privacy-policy" className="hover:text-classic-primary transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms-of-service" className="hover:text-classic-primary transition-colors">
              Terms of Service
            </Link>
            <Link href="#" className="hover:text-classic-primary transition-colors">
              Sitemap
            </Link>
            <button
